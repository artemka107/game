...
window.Game = (function() {
  ...
  Game.prototype = {
     ...
     */
    _drawWinMessage: function() {
      this.ctx.fillStyle = 'rgba(0, 0, 0, 0.7)';
      this.ctx.fillRect(270, 40, 300, 150);
      this.ctx.fillStyle = '#FFFFFF';
      this.ctx.fillRect(260, 30, 300, 150);
      this.ctx.fillStyle = 'black';
      this.ctx.font = '16px PT Mono';
      this.ctx.fillText('You have won! ', 300, 100);
    },

    _drawFailMessage: function() {
      this.ctx.fillStyle = 'rgba(0, 0, 0, 0.7)';
      this.ctx.fillRect(270, 40, 300, 150);
      this.ctx.fillStyle = '#FFFFFF';
      this.ctx.fillRect(260, 30, 300, 150);
      this.ctx.fillStyle = 'black';
      this.ctx.font = '16px PT Mono';
      this.ctx.fillText('You have failed! ', 300, 100);
    },

    _drawPauseMessage: function() {
      this.ctx.fillStyle = 'rgba(0, 0, 0, 0.7)';
      this.ctx.fillRect(270, 40, 300, 150);
      this.ctx.fillStyle = '#FFFFFF';
      this.ctx.fillRect(260, 30, 300, 150);
      this.ctx.fillStyle = 'black';
      this.ctx.font = '16px PT Mono';
      this.ctx.fillText('The game is on pause! ', 300, 100);
    },

    _drawWelcomeMessage: function() {
      this.ctx.fillStyle = 'rgba(0, 0, 0, 0.7)';
      this.ctx.fillRect(270, 40, 300, 150);
      this.ctx.fillStyle = '#FFFFFF';
      this.ctx.fillRect(260, 30, 300, 150);
      this.ctx.fillStyle = 'black';
      this.ctx.font = '16px PT Mono';
      this.ctx.fillText('Welcome to our game! ', 300, 100);
      this.ctx.fillText('Press space to start', 300, 120);
    },

    _drawPauseScreen: function() {
      switch (this.state.currentStatus) {
        case Verdict.WIN:
          this._drawWinMessage();
          break;
        case Verdict.FAIL:
          this._drawFailMessage();
          break;
        case Verdict.PAUSE:
          this._drawPauseMessage();
          break;
        case Verdict.INTRO:
